...
public interface StackApi {
    ...
    void stackItem(@Parameter(description = "New item to be added to the stack. Empty values are not allowed for this parameter!", required = true) @RequestBody String newItem);
